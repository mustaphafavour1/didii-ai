...
export function Hero() {
  return (
    <section className="relative min-h-screen bg-ink flex flex-col overflow-hidden" aria-label="Hero">
      {/* Yellow aurora glow */}
      <div className="aurora-blob absolute top-1/4 right-0 w-[700px] h-[700px] pointer-events-none -translate-y-1/4 translate-x-1/3"
      ...
      <div className="aurora-blob absolute -bottom-20 left-1/4 w-[400px] h-[400px] pointer-events-none"
           style={{ background: 'radial-gradient(ellipse at center, rgba(226,97,60,0.1) 0%, transparent 65%)', animationDelay: '2s' }} />
        ...
        <div className="max-w-7xl mx-auto w-full px-5 sm:px-8 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center flex-1">
          ...
          <div className="flex flex-col gap-7 lg:max-w-[560px]">
            ...
            <StaggerReveal delay={0.05}>
              <div className="inline-flex items-center gap-2 rounded-pill border border-yellow-500/25 bg-yellow-500/8 px-4 py-1.5 w-fit">
            ...
            <StaggerReveal delay={0.12}>
              ...
              >
                <FunHeadline as="span">Your money moves</FunHeadline>
                <br />
                <FunHeadline as="span" className="text-yellow-500">when you talk.</FunHeadline>
              </h1>
            </StaggerReveal>
            ...
            <StaggerReveal delay={0.2}>
              <p className="text-muted text-base sm:text-lg leading-relaxed max-w-[460px]">
                didii is the AI you just talk to about your money. Send, pay bills, buy data, cash out crypto — just say it.
              </p>
            </StaggerReveal>
            ...
            <StaggerReveal delay={0.35}>
              <div className="flex flex-wrap gap-4 items-center pt-1">
                {['Anchor partner bank', 'CBN licensed', 'NDIC-insured deposits'].map((item) => (
          ...
          {/* ── Right: Phone with input overlay ───────────────── */}
          <StaggerReveal delay={0.18} direction="right" className="flex flex-col items-center lg:items-end gap-5">
            <div className="relative">
              {/* Glow under phone */}
              <div className="absolute inset-0 scale-75 translate-y-10 blur-3xl rounded-full pointer-events-none"
              ...
              >
                ...
                <div className="absolute bottom-0 inset-x-0 p-3"
                     style={{ background: 'linear-gradient(to top, rgba(12,14,26,0.95) 60%, transparent)' }}>
                  <HeroInputCycler />
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-2.5 flex-wrap justify-center">
              <span className="flex items-center gap-1.5 text-xs px-3.5 py-1.5 rounded-pill border border-yellow-500/25 bg-yellow-500/8 text-yellow-500 font-medium">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
                  <path d="M6 1l1.24 3.81H11L7.88 6.89 9.12 10.7 6 8.62 2.88 10.7 4.12 6.89 1 4.81h3.76L6 1z" fill="currentColor"/>
                </svg>
                2,859 on waitlist
              </span>
